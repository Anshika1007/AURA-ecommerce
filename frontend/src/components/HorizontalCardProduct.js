      ...
      <div className="flex items-center gap-4 md:gap-6 overflow-scroll scrollbar-none transition-all" ref={scrollElement}>
        ...
        {loading
          ? loadingList.map((_, index) => (
              <div key={index} className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-slate-100 rounded-sm shadow flex">
                ...
                <div className="p-4 grid w-full gap-2">
                  ...
                  <button className="text-white px-3 py-0.5 rounded-full text-sm w-full bg-slate-200 animate-pulse p-1"></button>
                </div>
              </div>
            ))
          : data.map((product, index) => (
              <Link to={"product/"+product?._id}  className="w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] h-36 bg-slate-100 rounded-sm shadow flex">
